...
$entityCalendarStatus = "sensor.calendar_status"
$entityCalendarStatusName = "Calendar status"
$entityNextMeeting = "sensor.next_meeting"
$entityNextMeetingName = "Next meeting"
